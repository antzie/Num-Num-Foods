...
for category in session.query(FoodCategory).filter_by(name='Dairy Products').all():
  ...
  category.image = 'https://raw.githubusercontent.com/antzie/Calla-Grocer-Catalogue/master/static/css/strawberry-juice-cocktail-glass-and-dessert-website-header%20(1).jpg'
